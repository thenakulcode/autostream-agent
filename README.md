...
A production-grade conversational AI agent that qualifies social media users into business leads for **AutoStream**, a fictional SaaS video editing platform for content creators. Built with LangGraph, Gemini 2.0 Flash, and a local RAG knowledge base.
